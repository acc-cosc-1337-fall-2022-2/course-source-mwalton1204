...
TEST_CASE("Test get_letter_grade_using_if function")
{
    ...
    REQUIRE(get_letter_grade_using_if(101) == "Error: Invalid Grade");
    REQUIRE(get_letter_grade_using_if(-1) == "Error: Invalid Grade");
}
...
TEST_CASE("Test get_letter_grade_using_switch function")
{
    ...
    REQUIRE(get_letter_grade_using_switch(101) == "Error: Invalid Grade");
    REQUIRE(get_letter_grade_using_switch(-1) == "Error: Invalid Grade");
}